package com.ihomziak.bankingapp.transactionms.aspect;
...
@Aspect
@Component
public class TransactionControllerLoggingAspect {

    @Pointcut("execution(* com.ihomziak.bankingapp.transactionms.controller.*.*(..))")
